...
$form.Text = 'Stock Game Pro 2.2 - Setup'
...
$sub.Text = 'One-click Windows installation • Version 2.2'
...
$installButton.Add_Click({
    try {
        ...
        if ($desktop.Checked) {
            ...
            New-Shortcut (Join-Path $desktopDir 'Stock Game Pro.lnk') $pythonw $args $installDir 'Stock Game Pro 2.2'
        }
        if ($startMenu.Checked) {
            $programs = [Environment]::GetFolderPath('Programs')
            $folder = Join-Path $programs 'Stock Game Pro'
            New-Item -ItemType Directory -Force -Path $folder | Out-Null
            New-Shortcut (Join-Path $folder 'Stock Game Pro.lnk') $pythonw $args $installDir 'Stock Game Pro 2.2'
        ...
        Set-ItemProperty -Path $uninstallKey -Name DisplayName -Value 'Stock Game Pro 2.2'
        Set-ItemProperty -Path $uninstallKey -Name DisplayVersion -Value '2.2'
...
"@
        ...
        [System.Windows.Forms.MessageBox]::Show(
            "Stock Game Pro 2.2 is installed and ready to play.",
